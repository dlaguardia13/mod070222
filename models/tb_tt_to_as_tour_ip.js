...
module.exports = (sequelize, DataTypes) => {
  class tb_tt_to_as_tour_ip extends Model {
    /**
    ...
    static associate(models) {
      ...
      tb_tt_to_as_tour_ip.belongsTo(models.tb_tt_to_md_tour, {
        as: 'tb_tt_to_md_tour',
  ...
  tb_tt_to_as_tour_ip.init({
    ...
    modelName: 'tb_tt_to_as_tour_ip',
  });
  return tb_tt_to_as_tour_ip;
};